...
from app.models import Vehicle, Employee, ActivityLog, NotificationTemplate, NotificationLog, NotificationSchedule, User, VehicleCategory, EmployeeCategory, BatteryDrainRate, VehicleBatteryState  # noqa: F401
